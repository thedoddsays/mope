...
class LeftPanel(QWidget):
    ...
    def __init__(self):
        ...
        self.on_folder_removed    = None   # function(path: str)
    ...
    def _build(self):
        ...
        self._folder_panel.on_folder_removed  = self._relay_folder_removed
    ...
    def _relay_folder_removed(self, path):
        if self.on_folder_removed:
    ...
    def get_root(self) -> str:
        """Return the FolderPanel's current root path (for breadcrumb display)."""
        return self._folder_panel.get_root()
