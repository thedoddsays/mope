...
class ClickableLabel(QLabel):
    """A QLabel that emits clicked() on left-click, with a pointing-hand
    cursor — used for breadcrumb segments and any other label that should
    act like a link without pulling in a full QPushButton's chrome."""
